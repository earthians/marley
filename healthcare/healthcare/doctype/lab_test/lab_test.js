  ...
  refresh: function (frm) {
    ...
    if (
      ...
      frm.add_custom_button(__("Send SMS"), function () {
        frappe.call({
          method:
            "healthcare.healthcare.doctype.healthcare_settings.healthcare_settings.get_sms_text",
...
frappe.ui.form.on("Normal Test Result", {
  normal_test_items_remove: function () {
    frappe.msgprint(
      __("Not permitted, configure Lab Test Template as required")
    );
    cur_frm.reload_doc();
  },
});
...
var get_lab_test_prescribed = function (frm) {
  if (frm.doc.patient) {
    frappe.call({
      method:
        "healthcare.healthcare.doctype.lab_test.lab_test.get_lab_test_prescribed",
      args: { patient: frm.doc.patient },
      callback: function (r) {
