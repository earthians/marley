...
data = {
	...
	"custom_fields": {
		"Sales Invoice": [
			...
			{
				"fieldname": "total_insurance_claim_amount",
			...
			},
			{
				...
				"fieldtype": "Currency",
				"insert_after": "total_insurance_claim_amount",
				"read_only": True,
		...
		"Sales Invoice Item": [
			...
			},
			{
				...
				"depends_on": "eval: doc.insurance_claim",
			},
			{
				"fieldname": "insurance_claim_coverage",
				"label": "Healthcare Insurance Claim Coverage",
				"fieldtype": "Percent",
			...
			},
			{
				...
				"label": "Healthcare Insurance Claim Amount",
				"fieldtype": "Currency",
			...
			{
				"fieldname": "claim_qty",
				"label": "Healthcare Insurance Claim Approved Qty",
				"fieldtype": "Float",
			...
			},
			{
				...
				"label": "Healthcare Insurance Claim",
				"fieldtype": "Link",
				"read_only": True,
			...
			},
			{
				...
				"label": "Healthcare Insurance Company",
				"fieldtype": "Link",
				"read_only": True,
