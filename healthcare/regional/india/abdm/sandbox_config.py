...
config = {
	...
	"confirm_w_aadhaar_otp": {'method':'POST', 'url': 'v2/auth/confirmWithAadhaarOtp', 'encrypted': True},
	"confirm_w_mobile_otp": {'method':'POST', 'url': 'v2/auth/confirmWithMobileOTP', 'encrypted': True},
